...
public class Ex1 {
	...
	public static void main(String[] argv) {
		...
		try {
			...
			System.err.println("Error while initializing the field:"
					+ e.getMessage());
			// e.printStackTrace();
			System.exit(-1);
		}
		...
		boolean[][][] resultSerial = sGol.invoke(field, hSplit, vSplit,
				nGenerations);
		...
		boolean[][][] resultParallel = pGol.invoke(field, hSplit, vSplit,
				nGenerations);
	...
	public static void printArray(boolean[][] arr, String filename)
			throws Exception {
